...
#include "bin_avl_tree_node.h"			// 二叉平衡树结点
...
//	辅助函数模板:
	BinAVLTreeNode<ElemType> *CopyTreeHelp(const BinAVLTreeNode<ElemType> *r);	// 复制二叉平衡树
	void DestroyHelp(BinAVLTreeNode<ElemType> * &r);						// 销毁以r为根二叉平衡树
	void PreOrderHelp(const BinAVLTreeNode<ElemType> *r, void (*visit)(const ElemType &)) const;	// 先序遍历
	void InOrderHelp(const BinAVLTreeNode<ElemType> *r, void (*visit)(const ElemType &)) const;	// 中序遍历
	void PostOrderHelp(const BinAVLTreeNode<ElemType> *r, void (*visit)(const ElemType &)) const;	// 后序遍历
...
//  二叉平衡树方法声明及重载编译系统默认方法声明:
	...
	bool GetElem(const BinAVLTreeNode<ElemType> *cur, ElemType &e) const;
		// 用e返回结点数据元素值
	bool SetElem(BinAVLTreeNode<ElemType> *cur, const ElemType &e);
		// 将结cur的值置为e
...
template <class ElemType, class KeyType>
bool BinaryAVLTree<ElemType, KeyType>::GetElem(const BinAVLTreeNode<ElemType> *cur, ElemType &e) const
...
template <class ElemType, class KeyType>
bool BinaryAVLTree<ElemType, KeyType>::SetElem(BinAVLTreeNode<ElemType> *cur, const ElemType &e)
...
template <class ElemType, class KeyType>
void BinaryAVLTree<ElemType, KeyType>::PreOrderHelp(const BinAVLTreeNode<ElemType> *r, void (*visit)(const ElemType &)) const
// 操作结果：先序遍历以r为根的二叉平衡树
{
	if (r != NULL) 
	{
...
template <class ElemType, class KeyType>
void BinaryAVLTree<ElemType, KeyType>::InOrderHelp(const BinAVLTreeNode<ElemType> *r, void (*visit)(const ElemType &)) const
// 操作结果：中序遍历以r为根的二叉平衡树
{
	if (r != NULL) 
	{
...
template <class ElemType, class KeyType>
void BinaryAVLTree<ElemType, KeyType>::PostOrderHelp(const BinAVLTreeNode<ElemType> *r, void (*visit)(const ElemType &)) const
// 操作结果：后序遍历以r为根的二叉平衡树
{
	if (r != NULL) 
	{
...
template <class ElemType, class KeyType>
BinAVLTreeNode<ElemType> *BinaryAVLTree<ElemType, KeyType>::CopyTreeHelp(const BinAVLTreeNode<ElemType> *r)
// 操作结果：将以r为根的二叉平衡树复制成新的二叉平衡树,返回新二叉平衡树的根
{
	if (r == NULL)
	{	// 复制空二叉平衡树
	...
	{	// 复制非空二叉平衡树
		BinAVLTreeNode<ElemType> *lChild = CopyTreeHelp(r->leftChild);	// 复制左子树
		BinAVLTreeNode<ElemType> *rChild = CopyTreeHelp(r->rightChild);	// 复制右子树
		BinAVLTreeNode<ElemType> *rt = new BinAVLTreeNode<ElemType>(r->data, r->bf, lChild, rChild);
			// 复制根结点
		return rt;
	}
}
