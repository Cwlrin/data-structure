...
//	辅助函数模板:
	BinTreeNode<ElemType> *CopyTreeHelp(BinTreeNode<ElemType> *r);		// 复制二叉排序树
...
//  二叉排序树方法声明及重载编译系统默认方法声明:
	...
	bool GetElem(BinTreeNode<ElemType> *cur, ElemType &e) const;
		// 用e返回结点数据元素值
...
template <class ElemType, class KeyType>
bool BinarySortTree<ElemType, KeyType>::GetElem(BinTreeNode<ElemType> *cur, ElemType &e) const
...
template <class ElemType, class KeyType>
BinTreeNode<ElemType> *BinarySortTree<ElemType, KeyType>::CopyTreeHelp(BinTreeNode<ElemType> *r)
